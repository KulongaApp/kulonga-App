    ...
    <SafeAreaView style={s.safe}>
      <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
        ...
        <TouchableOpacity style={s.card} onPress={() => router.push('/(auth)/cadastro-professor' as any)}>
          <Text style={s.icon}>👨‍🏫</Text><View style={{ flex: 1, marginLeft: 12 }}><Text style={s.cardTitle}>Professor — Ativar conta</Text><Text style={s.cardDesc}>Foste adicionado pela escola? Cria a senha com o mesmo email</Text></View><Ionicons name="chevron-forward" size={18} color="#9CA3AF" />
        </TouchableOpacity>
